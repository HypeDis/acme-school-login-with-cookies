...
describe('Models', () => {
  ...
  describe('seeded data', () => {
    ...
    it('ethel is at MIT', () => {
      expect(seeded.students['ethel@aol.com'].schoolId).to.equal(
        seeded.schools.MIT.id
      );
    });
    it('moe is at Harvard', () => {
      expect(seeded.students['moe@gmail.com'].schoolId).to.equal(
        seeded.schools.Harvard.id
      );
    });
    it('lucy is at Harvard', () => {
      expect(seeded.students['lucy@gmail.com'].schoolId).to.equal(
        seeded.schools.Harvard.id
      );
    });
  });
